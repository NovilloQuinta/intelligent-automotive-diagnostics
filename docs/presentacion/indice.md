...
> 14 slides, ~15 min. **Se trabaja punto por punto**: el autor cuenta que va en el punto,
...
| 10 | Proveedor intercambiable y auto-aprendizaje | 1:00 | pendiente |
| 11 | Demo | 2:00 | pendiente |
| 12 | Calidad: TDD, tests, CI, seguridad | 0:55 | pendiente |
| 13 | Conclusiones | 0:45 | pendiente |
...
- Las dos slides de bases de datos se funden en una: explicar que es una tabla relacional
  no aporta nada a un tribunal tecnico. La slide entra directa a que guarda la vectorial.
