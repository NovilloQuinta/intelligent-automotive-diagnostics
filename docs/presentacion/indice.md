...
> 15 slides, ~15 min. **Se trabaja punto por punto**: el autor cuenta que va en el punto,
...
| 9 | MCP: las herramientas que se le dan al LLM | 1:10 | pendiente |
...
| 12 | Demo | 2:00 | pendiente |
| 13 | Calidad: TDD, tests, CI, seguridad | 0:55 | pendiente |
| 14 | Conclusiones | 0:45 | pendiente |
