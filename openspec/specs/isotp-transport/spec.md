...
ISO 15765-2 (ISO-TP) transport layer for CAN Bus — provides frame type definitions, PCI byte encoding/decoding, multi-frame reassembly, and payload segmentation. Enables reading VIN and other multi-frame payloads over OBD-II CAN Bus.

> TBD: Add detailed purpose when integrated with Elm327TcpRepository.
