...
>(
  (
    ...
    // Internal uncontrolled state — used when no openProp/setOpenProp are provided
    ...
    // Expose open/closed as data-state attribute for Tailwind variants (group-data-[state=expanded])
