      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-1 text-sm">
            ...
            <p>
              Workshop:{" "}
              <span className="font-bold">{data.userStats.byUserType.workshop ?? 0}</span>
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-1 text-sm">
            <p>
              User:{" "}
              <span className="font-bold">{data.userStats.byRole.user ?? 0}</span>
            </p>
            <p>
              Admin:{" "}
              <span className="font-bold">{data.userStats.byRole.admin ?? 0}</span>
            </p>
          </div>
        </CardContent>
      </Card>
