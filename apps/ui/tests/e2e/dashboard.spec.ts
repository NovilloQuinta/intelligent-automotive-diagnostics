...
test.describe('Dashboard', () => {
  test('should identify the vehicle before entering the diagnosis menu', async ({ page }) => {
  ...
  test('should switch vehicle from Audi to Kawasaki', async ({ page }) => {
    ...
    // Vehicle changed
    await expect(page.getByRole('button', { name: /Kawasaki Z900/ }).first()).toBeVisible()
  })
  ...
  test('should show the freeze frame snapshot when selecting a DTC on Audi', async ({ page }) => {
