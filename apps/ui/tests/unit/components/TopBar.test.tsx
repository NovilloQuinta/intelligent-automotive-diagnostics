...
describe('TopBar', () => {
  ...
  it('should show the admin link when the user is an admin', () => {
    ...
    expect(screen.getByTitle('Panel de administración')).toBeDefined()
  ...
  it("should show a USB icon when the selected scenario has connectionType 'usb'", () => {
    render(<TopBar {...baseProps} scenarios={[scenarioUsb]} selectedId="usb" />)
  ...
  it("should show a Bluetooth icon when the selected scenario has connectionType 'bluetooth'", () => {
    render(<TopBar {...baseProps} scenarios={[scenarioBluetooth]} selectedId="bt" />)
  ...
  it('should show the Historial button for all authenticated users', () => {
    ...
    expect(screen.getByTitle('Historial de diagnósticos')).toBeDefined()
