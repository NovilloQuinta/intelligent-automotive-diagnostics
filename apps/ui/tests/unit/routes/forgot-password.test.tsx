...
const ForgotPasswordPage = (Route as unknown as { options: { component: React.ComponentType } })
  .options.component
...
describe('ForgotPasswordPage', () => {
  ...
  it('calls api.forgotPassword and always shows the generic success message', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/Si el email existe, te hemos enviado un enlace de recuperación/i),
      ).toBeDefined()
    })
  })
