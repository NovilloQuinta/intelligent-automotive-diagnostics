 ...
 *
 * Implementa {@link Elm327TransportPort} sobre un puerto serie, delegando la
 ...
 */
export function createElm327SerialClient(config: SerialConfig): Elm327TransportPort {
